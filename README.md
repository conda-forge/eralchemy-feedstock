...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eralchemy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14256&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eralchemy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eralchemy` can be installed with:

```
conda install eralchemy
```

It is possible to list all of the versions of `eralchemy` available on your platform with:
